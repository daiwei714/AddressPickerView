...
import com.addresspicker.adapter.CityAdapter;
import com.addresspicker.adapter.DistrictAdapter;
import com.addresspicker.adapter.ProvinceAdapter;
...
public class AddressPickerView extends Dialog {
    ...
    public AddressPickerView(@NonNull Context context, int themeResId, List<AddressBean> addressBeans) {
